...
class LSTM(nn.Module):
    def __init__(self, args):
        ...
        self.linear_cont = nn.Linear(5, self.hidden_dim)
    ...
    def forward(self, input):
        ...
        test, question, tag, _, Tagrate, answerrate, elapsed, cumAnswerRate, Timestamp, mask, interaction = input
        ...
        Timestamp = Timestamp.unsqueeze(2)
        
        embed_cont = self.linear_cont(torch.cat([Tagrate, answerrate, elapsed, cumAnswerRate, Timestamp], 2))
